...
class TapFlowTest(common.HeatTestCase):
    ...
    def test_resource_handle_create(self):
        mock_tap_flow_create = self.test_client_plugin.create_taas_resource
    ...
    def test_resource_handle_delete(self):
        mock_tap_flow_delete = self.test_client_plugin.delete_taas_resource
    ...
    def test_resource_show_resource(self):
        mock_tap_flow_get = self.test_client_plugin.show_taas_resource
    ...
    def test_resource_handle_update(self):
        mock_tap_flow_patch = self.test_client_plugin.update_taas_resource
        self.test_resource.resource_id = '477e8273-60a7-4c41-b683-fdb0bc7cd151'
